  ...
  const CustomInput = React.forwardRef(({ value, onClick }, ref) => (
    ...
    >
      <svg
        ...
        style={{ left: '0.75rem', position: 'absolute', top: '50%', transform: 'translateY(-50%)' }}
      >
      ...
      <form onSubmit={handleSubmit} >
        ...
        <div className="grid gap-4 py-4">
          <div className="space-y-2">
            <label htmlFor="gaol-name" className='text-sm text-[var(--heading-text)] font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70'>
              Goal Name *
            </label>
              <input 
                type="text" 
          ...
          <div className="space-y-2">
            <label htmlFor="target-amount" className='text-sm text-[var(--heading-text)] font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70'>
             Target Amount *
            </label>
          ...
          <div className="space-y-2">
            <label htmlFor="Initial-amount" className='text-sm text-[var(--heading-text)] font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 '>
