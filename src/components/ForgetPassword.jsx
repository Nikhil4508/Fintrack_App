      ...
      <div className="rounded-lg border border-[var(--sub-background-color)] bg-[var(--background-color)] shadow-sm w-full max-w-md">
        ...
        <form onSubmit={handleResetPassword}>
          ...
          <div className="items-center p-6 pt-0 flex flex-col space-y-4">
            <button
              className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors disabled:pointer-events-none disabled:opacity-50 bg-[var(--btn-primary-bg)] text-[var(--btn-text)] hover:bg-[var(--btn-hover-bg)] h-10 px-4 py-2 w-full cursor-pointer"
              type="submit"
              disabled={isLoading}
            >
              {isLoading ? (
